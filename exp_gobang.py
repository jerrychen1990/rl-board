...
from rlb.core import RandomAgent, Context
...
def test_min_max_with_human(episodes=5, value_decay=1.):
    minmax_agent1 = MinMaxAgent(name="minmax_agent1", action_num=action_num)
    minmax_agent1.train(env_cls=env_cls, value_decay=value_decay)
...
if __name__ == "__main__":
    ...
    # test_min_max(episodes=100, value_decay=0.9)
    test_drl()
    # train_ac()
